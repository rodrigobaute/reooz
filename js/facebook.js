/*1474901535,,JIT Construction: v2585770,en_US*/
...
__d('sdk.AppEvents',['Assert','sdk.Impressions','sdk.Runtime'],function $module_sdk_AppEvents(global,require,requireDynamic,requireLazy,module,exports,Assert,Impressions,Runtime){if(require.__markCompiled)require.__markCompiled();
...
__d('legacy:fb.appevents',['Assert','sdk.AppEvents','FB','sdk.feature','sdk.Runtime'],function $module_legacy_fb_appevents(global,require,requireDynamic,requireLazy,__DO_NOT_USE__module,__DO_NOT_USE__exports,Assert,AppEvents,FB,feature,Runtime){if(require.__markCompiled)require.__markCompiled();
...
__d('legacy:fb.canvas.presence',['sdk.RPC','sdk.Event'],(function $module_legacy_fb_canvas_presence(global,require,requireDynamic,requireLazy,__DO_NOT_USE__module,__DO_NOT_USE__exports,RPC,Event){if(require.__markCompiled)require.__markCompiled();
...
__d('legacy:fb.canvas.syncrequests',['sdk.RPC','sdk.Event'],(function $module_legacy_fb_canvas_syncrequests(global,require,requireDynamic,requireLazy,__DO_NOT_USE__module,__DO_NOT_USE__exports,RPC,Event){if(require.__markCompiled)require.__markCompiled();
...
__d('legacy:fb.versioned-sdk',['sdk.Runtime'],(function $module_legacy_fb_versioned_sdk(global,require,requireDynamic,requireLazy,__DO_NOT_USE__module,__DO_NOT_USE__exports,Runtime){if(require.__markCompiled)require.__markCompiled();
...
document.namespaces.add('fb');
    ...
    }  }).call(global);})(window.inDapIF ? parent.window : window, window);} catch (e) {new Image().src="https:\/\/www.facebook.com\/" + 'common/scribe_endpoint.php?c=jssdk_error&m='+encodeURIComponent('{"error":"LOAD", "extra": {"name":"'+e.name+'","line":"'+(e.lineNumber||e.line)+'","script":"'+(e.fileName||e.sourceURL||e.script)+'","stack":"'+(e.stackTrace||e.stack)+'","revision":"2585770","namespace":"FB","message":"'+e.message+'"}}');}